...
class Player(pygame.sprite.Sprite):
    def __init__(self) -> None:
        ...
        self.player_index = 0
        self.player_jump = pygame.image.load('graphics/Player/player_walk_1.png').convert_alpha()
...
# Initialize pygame
pygame.init()
# create black display surface
screen = pygame.display.set_mode((800, 400))
pygame.display.set_caption('Runner')
clock = pygame.time.Clock()

# declaring font pygame.font.Font(FONT_TYPE, FONT_SIZE)
...
# text_surface = test_font.render(TEXT, ANTIALIASING_BOOL, COLOR)
...
player_index = 0
player_jump = pygame.image.load('graphics/Player/player_walk_1.png').convert_alpha()
...
game_instr = test_font.render('Press R to begin', False, (111,196,169))
    ...
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type == obstacle_timer:
                obstacle_group.add(Obstacle(choice(seq=['fly', 'snail', 'snail', 'snail'])))
                # if randint(0,2):
